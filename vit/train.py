...
try:
    ...
    print("Warning: Some optimizers not found in path. Ensure 'optimizers' module exists.")
...
def get_optimizer(model, optim_name, hp, device):
    ...
    elif optim_name == 'rikfad':
        print('h: ', hp['h'], 'gamma: ', hp['gamma'], 'alpha: ', hp['alpha'], 'mu: ', hp['mu'])
        return iKFAD_R1(params, h=hp['h'], gamma=hp['gamma'], alpha=hp['alpha'], mu=hp['mu'])
